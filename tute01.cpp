...
int main(void) 
{
    float cm, inches; // define variables

    std::cout << "Enter the value for centimeeters : "; // data inputs and assigns
    std::cin >> cm;

    inches = cm / 2.54; //calculation cm to inches
    std::cout << "Number of inches is : " << inches; // displaying the result
